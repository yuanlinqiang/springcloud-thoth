...
@EnableConfigurationProperties(com.prometheus.thoth.data.kafka.config.KafkaProducerProperties.class)
@ConditionalOnClass(value = KafkaTemplate.class)
public class KafkaProducerAutoConfiguration {

    protected final Logger logger = LoggerFactory.getLogger(this.getClass());

    private com.prometheus.thoth.data.kafka.config.KafkaProducerProperties kafkaProducerProperties;

    public KafkaProducerAutoConfiguration(com.prometheus.thoth.data.kafka.config.KafkaProducerProperties kafkaProducerProperties) {
